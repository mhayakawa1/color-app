    ...
    <Feature>
      ...
      <Display>
        <div className='colors-container'>
          ...
          {schemeArr.length % 3 === 1 || schemeArr.length % 3 === 2 ? <div aria-hidden='true' className='filler'></div> : null}
          {schemeArr.length % 3 === 1 ? <div aria-hidden='true' className='filler'></div> : null}
        </div>
      </Display>
    </Feature>
  )
